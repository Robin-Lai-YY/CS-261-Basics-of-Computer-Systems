...
/*
 * Replacement policies. Use it like:
 * if (policy & CACHE_REPLACEMENTPOLICY_MASK ==
 *      CACHE_REPLACEMENTPOLICY_LRU) { ... }
 */
#define CACHE_REPLACEMENTPOLICY_MASK   1

#define CACHE_REPLACEMENTPOLICY_RANDOM 0
#define CACHE_REPLACEMENTPOLICY_LRU    1
